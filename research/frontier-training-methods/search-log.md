...
- Four sweep items were kept with verified=no on the execution date because two fetch attempts failed (2601.05607; 2604.15804; 2603.09938; the ICLR 2026 CoT-Pass@K poster), and one Path 3 item, Foreign Sparse Attention, was reachable only through OpenReview and held Tier B unverified. A follow-up pass on September 5, 2026 verified all five against a primary page. Section "Follow-up verification pass" records the queries and the two re-grades that followed.
- The frontier recipe register covers 67 model entries, 65 of them verified against an arXiv abstract page, an official post, a GitHub README, or a system card. Two requested entries were unverifiable: Apple Foundation Models 2026 (no 2026 report exists) and xAI Grok 5 (unreleased as of the execution date; xAI shipped Grok 4.5 on July 8 and Grok 4.6 on August 12, 2026). Kimi K3's pretraining token count was not located in its report, and the follow-up pass re-read the report's abstract, introduction, and pre-training section and confirmed the count stays undisclosed.
...
Executed September 5, 2026, after the merge of the research program, to close the five items that carried verified=no. Every item was fetched through Exa against a primary page.

| # | Channel | Query or URL | Outcome |
|---|---|---|---|
| F1 | Exa fetch | arxiv.org/abs/2601.05607 | Verified. Zijun Min et al., Xiamen University, Shopee, and AIR Tsinghua; v1 2026-01-09. DHPO mixes token-level and sequence-level importance ratios in one clipped surrogate. "We will release our code upon acceptance" names no venue, so Tier D holds |
| F2 | Exa fetch | arxiv.org/abs/2604.15804 | Verified. Qwen Team, v1 2026-04-17, v2 2026-04-22. Hundreds of billions of parameters, 256k context, Hybrid Attention MoE, ARIA alignment. Tier C holds |
| F3 | Exa fetch | arxiv.org/abs/2603.09938 | Verified. Mingyang Song and Mao Zheng, v1 2026-03-10, FUSE taxonomy survey. Tier D holds |
| F4 | Exa search | CoT-Pass@K ICLR 2026 poster authors | Verified. arXiv 2506.14245, Xumeng Wen et al., Microsoft Research Asia, v1 2025-06-17; ICLR 2026 poster 10007896; OpenReview jGbRWwIidy. Tier A holds, and the report now cites the authors by name |
| F5 | Exa search, Exa fetch | Foreign Sparse Attention; icml.cc/virtual/2025/51812 | Verified, and re-graded. The ICML page reads "Poster in Workshop: ES-FoMo III: 3rd Workshop on Efficient Systems for Foundation Models." Authors Vijaykaarti Sundarapandiyan, Tom Goldstein, Ashwinee Panda. Workshop, so Tier D under the plan's main-track rule, down from Tier B |
| F6 | Exa search, Exa fetch | Kimi K3 pretraining tokens; arxiv.org/html/2607.24653v1 | Count still undisclosed. The report gives parameters, activated parameters, context curriculum from 8k to 1M, optimizer, weight decay, and schedule, and states no pretraining token count |
| F7 | Exa fetch | kexue.fm/archives/11619 | Crawl failed again with the same error as the execution date. The Quantile Balancing blog keeps verified=no |
