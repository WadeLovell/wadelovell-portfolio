...
0. **A partial re-grade ran on September 17, 2026.** UltraLong (2504.06214) moved to Tier A on its ACL 2026 Findings publication. Truncated Importance Sampling (openreview:xsonlP8DRV) moved to Tier D as a workshop paper, the second such misfile after Foreign Sparse Attention. Six Tier B items proved to sit outside the ICLR 2026 proceedings index and keep Tier B with that evidence recorded. `search-log.md` carries the pass. A full venue-column audit followed it: all 355 rows were checked for tier-versus-venue contradictions, no workshop paper remains at Tier A or B, and the four Tier A rows that rested on secondary evidence were each confirmed against a venue page, REAP at rank 3 among them.

0b. **The September 25 re-grade ran and is partly open.** Four items published elsewhere and moved to Tier A: Dr. GRPO (COLM 2025), MergeBench (NeurIPS 2025 Datasets and Benchmarks), GPTailor and Compute-Optimal QAT (both ICLR 2026). Counts stand at 115 Tier A and 14 Tier B. NeurIPS 2026 published no accepted-paper index three hours after notifications closed, so nine items await it. A September 17 error was corrected: the report does cite Truncated Importance Sampling, under the key "Yao et al., 2025."

1. **NeurIPS 2026 re-check, once an index exists.** NeurIPS 2026 notifications land September 24 Anywhere on Earth, which runs to 11:59 UTC on September 25, so the trigger fires on the 25th. Fourteen Tier B items may move to A or D: the entropy-mechanism paper (2505.22617), pass@k training (2508.10751), PRIME (2502.01456), RLPR (2506.18254), Dr. GRPO (2503.20783), DeepSeek-GRM (2504.02495), Invisible Leash (2507.14843), and the others listed under Tier B in `references.md`. The ranking in Section 7 may shift if the entropy-mechanism, pass@k, or implicit-process-reward items publish. A scheduled trigger fires that morning with the full brief.
